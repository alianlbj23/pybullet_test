"""Main module for the pros_car_py package, handling keyboard control and ROS2 integration."""
import os
import sys
import time
import io
...
from pros_car_py.ik_solver import PybulletRobotIKSolver
...
def main():
    ...
    ik_solver = PybulletRobotIKSolver()
