...
: ${AMENT_CURRENT_PREFIX:="/home/user/workspace/pyrobot/moveit_docker_activate/install/new_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/new_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/new_config/environment/path.sh"
