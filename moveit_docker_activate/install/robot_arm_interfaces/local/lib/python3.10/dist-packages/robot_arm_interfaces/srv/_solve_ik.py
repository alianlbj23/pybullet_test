...
class Metaclass_SolveIK(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_arm_interfaces.srv.SolveIK')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_arm_interfaces.srv import _solve_ik
...
class SolveIK(metaclass=Metaclass_SolveIK):
    from robot_arm_interfaces.srv._solve_ik import SolveIK_Request as Request
    from robot_arm_interfaces.srv._solve_ik import SolveIK_Response as Response
