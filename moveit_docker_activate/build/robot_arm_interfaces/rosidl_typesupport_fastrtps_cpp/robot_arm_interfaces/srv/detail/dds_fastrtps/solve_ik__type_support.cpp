...
#include "robot_arm_interfaces/srv/detail/solve_ik__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_arm_interfaces::srv::SolveIK_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_arm_interfaces::srv::SolveIK_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_arm_interfaces::srv::SolveIK_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_arm_interfaces::srv::SolveIK_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_arm_interfaces::srv::SolveIK_Request *>(
    untyped_ros_message);
...
{
  return &robot_arm_interfaces::srv::typesupport_fastrtps_cpp::_SolveIK_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_arm_interfaces, srv, SolveIK_Request)() {
  return &robot_arm_interfaces::srv::typesupport_fastrtps_cpp::_SolveIK_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_arm_interfaces
cdr_serialize(
  const robot_arm_interfaces::srv::SolveIK_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_arm_interfaces::srv::SolveIK_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_arm_interfaces::srv::SolveIK_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_arm_interfaces::srv::SolveIK_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_arm_interfaces::srv::SolveIK_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robot_arm_interfaces::srv::typesupport_fastrtps_cpp::_SolveIK_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_arm_interfaces, srv, SolveIK_Response)() {
  return &robot_arm_interfaces::srv::typesupport_fastrtps_cpp::_SolveIK_Response__handle;
}
...
{
  return &robot_arm_interfaces::srv::typesupport_fastrtps_cpp::_SolveIK__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_arm_interfaces, srv, SolveIK)() {
  return &robot_arm_interfaces::srv::typesupport_fastrtps_cpp::_SolveIK__handle;
}
