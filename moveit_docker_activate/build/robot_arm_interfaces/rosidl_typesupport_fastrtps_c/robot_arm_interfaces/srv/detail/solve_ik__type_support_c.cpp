...
#include "robot_arm_interfaces/srv/detail/solve_ik__rosidl_typesupport_fastrtps_c.h"
...
using _SolveIK_Request__ros_msg_type = robot_arm_interfaces__srv__SolveIK_Request;
...
size_t get_serialized_size_robot_arm_interfaces__srv__SolveIK_Request(
  const void * untyped_ros_message,
...
static uint32_t _SolveIK_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_arm_interfaces__srv__SolveIK_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_arm_interfaces
size_t max_serialized_size_robot_arm_interfaces__srv__SolveIK_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_arm_interfaces__srv__SolveIK_Request;
    is_plain =
      (
...
static size_t _SolveIK_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_arm_interfaces__srv__SolveIK_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_arm_interfaces, srv, SolveIK_Request)() {
...
using _SolveIK_Response__ros_msg_type = robot_arm_interfaces__srv__SolveIK_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_arm_interfaces
size_t get_serialized_size_robot_arm_interfaces__srv__SolveIK_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SolveIK_Response__ros_msg_type * ros_message = static_cast<const _SolveIK_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_arm_interfaces__srv__SolveIK_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_arm_interfaces
size_t max_serialized_size_robot_arm_interfaces__srv__SolveIK_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_arm_interfaces__srv__SolveIK_Response;
    is_plain =
      (
...
static size_t _SolveIK_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_arm_interfaces__srv__SolveIK_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_arm_interfaces, srv, SolveIK_Response)() {
...
// already included above
// #include "robot_arm_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robot_arm_interfaces/srv/solve_ik.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_arm_interfaces, srv, SolveIK)() {
